...
const Hero: FC<THeroProps> = ({
  ...
  return (
    <div className="relative overflow-visible min-h-[80vh] sm:min-h-[85vh] flex items-center justify-center pt-[60px] sm:pt-[80px] mt-[-60px] sm:mt-[-130px]">
      {/* Particle background */}
      ...
      >
        ...
        <motion.div
          ...
          className="w-full max-w-[760px] px-4"
        >
